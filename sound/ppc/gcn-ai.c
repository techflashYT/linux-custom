 ...
 * DSP registers.
 */
#define AI_DSP_MBOX_H		0x00
#define AI_DSP_MBOX_L		0x02
		   ...
		   unsigned int irq)
{
	...
	// HACK: stop transition audio on latte
	out_be16(chip->dsp_base + AI_DSP_MBOX_H, 0x8800);
	out_be16(chip->dsp_base + AI_DSP_MBOX_L, 0x0000);
