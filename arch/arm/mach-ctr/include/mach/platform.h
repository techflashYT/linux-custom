...
#define NINTENDO3DS_FB_TOP_SIZE		(NINTENDO3DS_LCD_TOP_WIDTH * NINTENDO3DS_LCD_TOP_HEIGHT * 2)
#define NINTENDO3DS_FB_BOT_SIZE		(NINTENDO3DS_LCD_BOT_WIDTH * NINTENDO3DS_LCD_BOT_HEIGHT * 3)
